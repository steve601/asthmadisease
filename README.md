...
## Overview
->Diaognise whether a patient has asthma disease or not.
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/steve601/asthmadisease.git
    cd asthmadisease
    ```
...
**Upload Application Code:**
    ...
    Place the code in a suitable directory, e.g., /home/ec2-user/asthma-disease
